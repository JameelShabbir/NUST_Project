...
def forget():
    ...
    signup_window.configure(bg="#e37168")  # Set background color
    ...
    signup_title_label = tk.Label(signup_window, text="Sign Up", font=(
        "Helvetica", 16, "bold"), background="#e37168")
...
def welcome_page(username):
    ...
    welcome_window.configure(bg="green")  # Set background color
    ...
    welcome_label = tk.Label(
        welcome_window, text="We hope you are well and enjoying, {}!".format(username))
    welcome_label.pack(pady=50)
...
title_label = tk.Label(window, text="Login System", font=(
    "Helvetica", 26, "bold"), background='#e37168')
